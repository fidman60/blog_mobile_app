...
class WrappedBlurView extends Component {
    constructor(props) {
        ...
        if (children.props.style instanceof Array) {
            this.newStyles = [...children.props.style, myStyleOpactiy];
        } else {
            if (!children.props.style) {
                this.newStyles.push(children.props.style);
            }
            this.newStyles.push(myStyleOpactiy);
        }
    }
            ...
            <React.Fragment>
                ...
                }
                {
                    ...
                    <BlurView
                        ...
                        style={{ position: 'absolute', left: 0, top: 0, right: 0, width: viewportWidth, height: viewportHeight }}
